...
elseif strcmp(Data.boundary,'PP')
    M_no_bc(1,:) = M_no_bc(1,:) + M_no_bc(end,:);
    A_no_bc(1,:) = A_no_bc(1,:) + A_no_bc(end,:);

    M_no_bc(end,:) = 0;  M_no_bc(end,1) = 1;  M_no_bc(end,end) = -1;
    A_no_bc(end,:) = 0;  A_no_bc(end,1) = 1;  A_no_bc(end,end) = -1;
end
