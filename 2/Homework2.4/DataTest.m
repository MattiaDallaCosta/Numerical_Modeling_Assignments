...
if strcmp(TestName,'Homework2.4')
    ...
    % D = Dirichlet; N = Neumann; R = Robin; P = periodic; A = Absorbing
    Data.boundary = 'PP';
    ...
    Data.ro = 1.0;                  % rho = 1
    Data.mu = Data.g * Data.H;      % mu = gH  (constant)

    % wave speed: c = sqrt(mu/ro) = sqrt(gH)
    Data.c = sqrt(Data.mu / Data.ro);

    % No forcing
    Data.force = @(x,t) 0.*x.*t;

    % For periodic case put BC all to 0
